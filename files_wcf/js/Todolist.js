...
Todolist.Todo.UpdateHandler.Todo = Todolist.Todo.UpdateHandler.extend({
   ...
   _markAsUndone: function (todoID) {
       ...
       $('.jsMarkAsDone span:not(.doneTitle)')
           .html('<fa-icon name="square"></fa-icon>')
   ...
   _markAsDone: function (todoID) {
       ...
       $('.jsMarkAsDone span:not(.doneTitle)')
           .html('<fa-icon name="check-square"></fa-icon>')
...
Todolist.Todo.UpdateHandler.Todolist = Todolist.Todo.UpdateHandler.extend({
   ...
   _markAsUndone: function (todoID) {
       ...
       $('.jsMarkAsDone[data-object-id=' + todoID + ']')
           .html('<fa-icon name="square"></fa-icon>')
           .attr('aria-label', WCF.Language.get('todolist.general.isUndone'))
           .attr('data-tooltip', WCF.Language.get('todolist.general.isUndone'));
   },
...
Todolist.Todo.MarkAsDone = Class.extend({
   ...
   _click: function (event) {
       var $icon = $(event.currentTarget);
        var $isDone = ($icon.find('fa-icon').attr('name') == 'check-square' ? true : false);
       this._proxy.setOption('data', {
